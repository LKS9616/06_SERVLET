...
<h4> a태그의 href 속성에 파라미터를 쿼리스트링 형태로 작성하여 POST 방식 요청</h4>
<a href="http://localhost:8080/querystring?name=%EC%9D%B4%EA%B7%9C%EC%84%AD&age=28&birthday=1999-01-01&gender=M&national=ko&hobbies=movie">
    쿼리스트링을 이용한 값 전달
</a>
    <h3>GET 방식의 요청</h3>
