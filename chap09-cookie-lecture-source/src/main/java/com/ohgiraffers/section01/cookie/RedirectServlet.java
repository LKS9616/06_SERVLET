...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /*
        * 쿠키 사용하기
        * 1. request에서 쿠키 목록을 쿠키 배열 상태로 꺼내온다.
        * 2. 쿠키의 getName과 getValue를 이용해 쿠키에 담긴 값을 지정한다.
        * */
        ...
        * 개인 PC는 상관없지만, 공용PC 등 다른 사용자와 함께 쓰는 컴퓨터이면 (민감한 개인정보를 포함할 경우) 보안에 취약하다.
        * 따라서 민감한 개인 정보를 취급하는 경우에는 쿠키보다는 세션을 이용한다. 세션은 쿠키와 유사한 형태로 key=value 쌍으로 저장되지만
